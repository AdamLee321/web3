...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44389/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44389/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Book IT Application";
        ...
        using (Web3project_BookIT.Logic.ShoppingCartActions myCartOrders = new Web3project_BookIT.Logic.ShoppingCartActions())
        {
            ...
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Ticket.TicketName.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Ticket.UnitPrice.ToString();
